/*
* This component was adapted directly from https://github.com/weknowinc/react-bubble-chart-d3 
* (with a few minor tweaks for the crypto use case)
*/
...
export default class BubbleChart extends Component {
  ...
  renderLegend(width, height, offset, nodes, color) {
    ...
    .append("g")
      ...
      .on('mouseover', function(d) {
        d3.select('#' + d.id).attr("r", d.r * 1.00);
      })
      .on('mouseout', function(d) {
        const r = d.r - (d.r * 0.04);
